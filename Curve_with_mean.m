...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
my_file = 'AO50NF';
u1 = readmatrix(sprintf('mean_svd_%s_VisNorm.csv',my_file));
figure(1)
nexttile
plot(u1(:,1))
hold on
...
u2 = readmatrix(sprintf('mean_svd_%s_Vis2x.csv',my_file));
figure(1)
plot(u2(:,1))
hold on
figure(2)
...
u3 = readmatrix(sprintf('mean_svd_%s_VisHalf.csv',my_file));
figure(1)
plot(u3(:,1))
hold on
title('AO50')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(1)
export_fig(['MeanCurve1st'],'-png','-nocrop')

figure(2)
export_fig(['MeanCurve2ng'],'-png','-nocrop')

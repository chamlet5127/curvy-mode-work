...
% % % % for i=1:length(dir_name)
% % % %     
% % % %     PlotPhasesFnMod(dir_name{i},rws,clmns,i+clmns)
% % % %     
% % % % end
% % % % % % 
% % % % % % % %  Plot M8 Phase Plots
...
dir_name_N4_150 = {'HM4NSAR2','AO150N4','LC150N4','LC150N4Mult4','LC150N4Mult10'};
dir_name_M8_150 = {'HM8MPA','AO150M8','LC150M8','LC150M8Mult4','LC150M8Mult10'};
dir_name_N4_50 = {'HM4NSAR2','AO50N4','LC50N4','LC50N4Mult4','LC50N4Mult10'};
dir_name_M8_50 = {'HM8MPA','AO50M8','LC50M8','LC50M8Mult4','LC50M8Mult10'};
...
case_name = 'LC90N4';
sd=0;
COTfn(pullcut,dir_name, nfr, nsegs, asegs, dt,theta_segs,nosc,my_time,beg,daend,case_name,sd)
...
axis([1 6 0 18])
xticks([2 3 4 5])
xticklabels({'AO','x1','x4','x10'})
legend(for_legend)

% % set(8, 'Position', [0 0 0.8*screen_size(3) 0.8*screen_size(4) ] );
% % export_fig(['Figure8'],'-png','-nocrop')

dir_name_N4_150 = {'HM4NSAR2','AO150N4','SL150N4','SL150N4Mult4','SL150N4Mult10'};
dir_name_M8_150 = {'HM8MPA','AO150M8','SL150M8','SL150M8Mult4','SL150M8Mult10'};
dir_name_N4_50 = {'HM4NSAR2','AO50N4','SL50N4','SL50N4Mult4','SL50N4Mult10'};
dir_name_M8_50 = {'HM8MPA','AO50M8','SL50M8','SL50M8Mult4','SL50M8Mult10'};
...
ylabel('Normalized Cost of Transport (against uninjured case)')
...
dir_name = dir_name_N4_50;
PlotCOMSpeedFn(dir_name, nfr, nsegs, asegs,my_time)
title('FB=Mag Injury=30%')
% legend(legend_names)
set(9, 'Position', [0 0 0.8*screen_size(3) 0.6*screen_size(4) ] );

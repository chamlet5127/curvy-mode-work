...
rws = 3;
clmns = length(dir_name_N4_150);
figure(3)
set(3, 'Position', [0 0 0.6*screen_size(3) 0.8*screen_size(4) ] );
...
set(4, 'Position', [0 0 0.8*screen_size(3) 0.8*screen_size(4) ] );

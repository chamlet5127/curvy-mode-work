...
% % allfiles= ["HM0NSAR2","HM4NSAR2","AO50NF","AO50N4"];
% % allfiles= ["HM0NSAR2","HM4NSAR2","AO150NF","AO150N4"];
% % allfiles= ["HM0NSAR2","HM4NSAR2","SL50NF","SL50N4","SL50N4x10"];
allfiles =["HM0NSAR2","HM4NSAR2","SL150NF","SL150N4","SL150N4x10"]; %% ,"HM4NSAR2"%% ,
...
for i = 1:length(dirnames);
 ...
 export_fig(sprintf('./COMSpeed/grouped_com_%s',allfiles(3)),'-png','-nocrop')
    % % clf
% % % cm_mymap=viridis();
% % cm_mymap = my_map();

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
my_file = 'AO50NF';
u1 = readmatrix(sprintf('u1_%s_VisNorm.csv',my_file));
figure(1)
nexttile
plot(real(u1(:,1)))
hold on
...
u2 = readmatrix(sprintf('u1_%s_Vis2x.csv',my_file));
figure(1)
plot(real(u2(:,1)))
hold on
figure(2)
...
u3 = readmatrix(sprintf('u1_%s_VisHalf.csv',my_file));
figure(1)
plot(real(u3(:,1)))
hold on
title('AO50')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(1)
export_fig(['WaveForms1st'],'-png','-nocrop')

figure(2)
export_fig(['WaveForms2nd'],'-png','-nocrop')

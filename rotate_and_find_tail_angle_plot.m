function [x_rot, y_rot, theta_tail_rad, vertical_dist, d_x_updated, d_y_updated, dx_tail_updated, dy_tail_updated] = rotate_and_find_tail_angle_plot(x, y, x_c, y_c, d_x, d_y, prev_d_x, prev_d_y, prev_dx_tail, prev_dy_tail)
